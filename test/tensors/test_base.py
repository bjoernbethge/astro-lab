...
class TestAstroTensorBase:
    ...
    def test_tensor_creation(self):
        ...
        tensor = AstroTensorBase(data=data, tensor_type="test")
    ...
    def test_tensor_device_transfer(self):
        ...
        # Test CPU device
        cpu_tensor = AstroTensorBase(data=data)
        ...
        if torch.cuda.is_available():
            ...
            cuda_tensor = AstroTensorBase(data=cuda_data)
    ...
    def test_metadata_operations(self):
        ...
        tensor = AstroTensorBase(data=data, custom_field="test_value")
    ...
    def test_tensor_operations(self):
        ...
        tensor = AstroTensorBase(data=data, custom_field="test")
        ...
        unsqueezed_tensor = AstroTensorBase(data=unsqueezed_data, custom_field="test")
        assert unsqueezed_tensor.get_metadata("custom_field") == "test"

        squeezed_data = unsqueezed_data.squeeze(0)
        squeezed_tensor = AstroTensorBase(data=squeezed_data, custom_field="test")
    ...
    def test_mask_application(self):
        ...
        tensor = AstroTensorBase(data=data, test_field="value")
    ...
    def test_numpy_conversion(self):
        ...
        data = torch.randn(5, 3)
        tensor = AstroTensorBase(data=data)
