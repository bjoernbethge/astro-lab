...
from astro_lab.tensors import PhotometricTensor, LightcurveTensor
...
class TestModelForwardPass:
    ...
    def test_galaxy_model_forward(self):
        ...
        output = model(x, edge_index)
        # Without batch, pooling results in single output
        assert output.shape == (1, 12)  # Default output_dim
