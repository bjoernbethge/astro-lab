# PyPI Publishing Setup for astro-lab

This document explains how to configure PyPI publishing for the astro-lab package using GitHub Actions and trusted publishing.
...
5. Fill in the details:
   - **PyPI Project Name**: `astro-lab`
   - **Owner**: `bjoernbethge`
   - **Repository name**: `astro-lab`
...
1. Go to https://github.com/bjoernbethge/astro-lab/releases/new
2. Click "Choose a tag" and create a new tag (e.g., `v0.1.0`)
3. Set the release title (e.g., "astro-lab v0.1.0")
...
1. Go to https://github.com/bjoernbethge/astro-lab/actions/workflows/publish-pypi.yml
...
- https://pypi.org/project/astro-lab/

Install it using:
```bash
pip install astro-lab
```
