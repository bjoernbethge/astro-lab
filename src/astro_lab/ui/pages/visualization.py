...
from astro_lab.ui.components.viz import create_visualizer, create_plotly_viz, create_cosmic_web_viz
    ...
    if hasattr(app_state, "loaded_data") and app_state.loaded_data is not None:
        ...
        data_summary = mo.vstack([
            ...
            mo.hstack([
                ...
                mo.stat("Analysis", "✅" if hasattr(app_state, "analysis_result") else "❌"),
            ])
        ])
