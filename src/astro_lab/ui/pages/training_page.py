...
from ..components.training_config import create_training_config
...
def create_training_page():
    ...
    if loaded_data is None:
        return mo.vstack([
            ...
            mo.md("Training requires processed astronomical data with features and coordinates.")
        ])
    ...
    return mo.vstack([
        mo.md("# 🚀 Model Training"),
        mo.md("Train astronomical machine learning models using AstroLab's training framework."),
