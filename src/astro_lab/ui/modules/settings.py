...
from astro_lab.config import ConfigManager
from astro_lab.data.config import data_config
from astro_lab.training.config import training_config
...
def data_settings() -> mo.Html:
    ...
    return mo.vstack([
        ...
        mo.accordion({
            ...
            "Processing": mo.vstack([normalize, remove_outliers, outlier_threshold]),
        }),
        update_btn,
    ])
...
def model_settings() -> mo.Html:
    ...
    return mo.vstack([
        ...
        mo.accordion({
            ...
            "Memory": mo.vstack([gradient_checkpointing, gradient_accumulation]),
