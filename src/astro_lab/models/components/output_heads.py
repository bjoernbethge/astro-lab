...
def create_output_head(
    ...
    **kwargs
    ...
    """Simple factory function - no registry needed."""
    ...
    # Handle different parameter names for different heads
    if head_type == 'classification':
        return head_class(input_dim, num_classes=output_dim or 2, **kwargs)
    elif head_type == 'regression':
        return head_class(input_dim, output_dim=output_dim or 1, **kwargs)
    else:
        # Period detection and shape modeling don't need output_dim
        return head_class(input_dim, **kwargs) 