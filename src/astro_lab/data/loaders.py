...
Create DataLoaders for various astronomical datasets with GPU optimization:
...
_GPU_AVAILABLE = optimize_dataloader_for_gpu()
_DEFAULT_NUM_WORKERS = min(4, torch.get_num_threads()) if _GPU_AVAILABLE else 0
_DEFAULT_PIN_MEMORY = _GPU_AVAILABLE
