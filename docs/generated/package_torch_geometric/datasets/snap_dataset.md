...
### `read_ego(files: List[str], name: str) -> List[torch_geometric.datasets.snap_dataset.EgoData]`

### `read_soc(files: List[str], name: str) -> List[torch_geometric.data.data.Data]`

### `read_wiki(files: List[str], name: str) -> List[torch_geometric.data.data.Data]`
