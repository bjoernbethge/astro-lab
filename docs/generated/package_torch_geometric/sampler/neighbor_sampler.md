...
### `edge_sample(inputs: torch_geometric.sampler.base.EdgeSamplerInput, sample_fn: Callable, num_nodes: Union[int, Dict[str, int]], disjoint: bool, node_time: Union[torch.Tensor, Dict[str, torch.Tensor], NoneType] = None, neg_sampling: Optional[torch_geometric.sampler.base.NegativeSampling] = None) -> Union[torch_geometric.sampler.base.SamplerOutput, torch_geometric.sampler.base.HeteroSamplerOutput]`

Performs sampling from an edge sampler input, leveraging a sampling
function of the same signature as `node_sample`.

### `neg_sample(seed: torch.Tensor, neg_sampling: torch_geometric.sampler.base.NegativeSampling, num_nodes: int, seed_time: Optional[torch.Tensor], node_time: Optional[torch.Tensor], endpoint: Literal['str', 'dst']) -> torch.Tensor`

### `node_sample(inputs: torch_geometric.sampler.base.NodeSamplerInput, sample_fn: Callable) -> Union[torch_geometric.sampler.base.SamplerOutput, torch_geometric.sampler.base.HeteroSamplerOutput]`

Performs sampling from a :class:`NodeSamplerInput`, leveraging a
