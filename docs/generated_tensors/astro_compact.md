...
Auto-generated documentation for `astro_lab.models.astro`
...
```python
from astro_lab.models.astro import SurveyTensor
...
**`extract_survey_features(self, survey_tensor: astro_lab.tensors.survey.SurveyTensor) -> torch.Tensor`**

Extract features from SurveyTensor using native methods.

**`forward(self, x: Union[torch.Tensor, astro_lab.tensors.survey.SurveyTensor], edge_index: torch.Tensor, batch: Optional[torch.Tensor] = None, return_embeddings: bool = False) -> Union[torch.Tensor, Dict[str, torch.Tensor]]`**
