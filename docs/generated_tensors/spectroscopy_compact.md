...
Auto-generated documentation for `astro_lab.data.datasets.spectroscopy`
...
```python
from astro_lab.data.datasets.spectroscopy import SpectralTensor
...
```python
from astro_lab.data.datasets.spectroscopy import SurveyTensor
