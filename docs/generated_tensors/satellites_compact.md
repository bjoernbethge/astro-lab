...
Auto-generated documentation for `astro_lab.data.datasets.satellites`
...
```python
from astro_lab.data.datasets.satellites import Spatial3DTensor
...
```python
from astro_lab.data.datasets.satellites import SurveyTensor
