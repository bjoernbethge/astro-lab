...
Auto-generated documentation for `astro_lab.simulation.core`
...
```python
from astro_lab.simulation.core import LightcurveTensor
...
```python
from astro_lab.simulation.core import OrbitTensor
...
```python
from astro_lab.simulation.core import PhotometricTensor
...
```python
from astro_lab.simulation.core import Spatial3DTensor
...
```python
from astro_lab.simulation.core import SpectralTensor
...
```python
from astro_lab.simulation.core import SurveyTensor
...
Core simulation engine for astronomical tensor operations.

Provides functionality to generate synthetic astronomical data
and convert existing data into optimized tensor formats.

Enhanced with TNG50-4 support and spatial indexing capabilities.

#### Methods

**`load_catalog_data(self, catalog_name: str, max_objects: Optional[int] = None, filters: Optional[Dict[str, Any]] = None, return_tensor: bool = True) -> Union[Dict[str, Any], astro_lab.tensors.survey.SurveyTensor]`**
...
return_tensor: Return as SurveyTensor

Returns:
Data dictionary or SurveyTensor

**`load_tng50_data(self, snap_file: Union[str, pathlib.Path], particle_types: List[str] = ['PartType5'], max_particles: Optional[int] = None, return_tensor: bool = True) -> Dict[str, Any]`**

Load TNG50/IllustrisTNG simulation data.

Args:
snap_file: Path to HDF5 snapshot file
particle_types: List of particle types to load
max_particles: Maximum particles per type
return_tensor: Return as tensor format

Returns:
Dictionary with particle data

**`simulate_lightcurve_data(self, n_objects: int = 100, n_observations: int = 50, variability_types: Optional[List[str]] = None, return_tensor: bool = True) -> Union[Dict[str, Any], astro_lab.tensors.survey.SurveyTensor]`**

Simulate time-series lightcurve data.

Args:
n_objects: Number of objects to simulate
n_observations: Number of time points per object
variability_types: Types of variability to include
return_tensor: Return as SurveyTensor

Returns:
Data dictionary or SurveyTensor

**`create_spatial_index(self, positions: numpy.ndarray, box_size: float, index_type: str = 'auto', **kwargs)`**

Create spatial index for particle data.

Args:
positions: Particle positions [N, 3]
box_size: Simulation box size
index_type: Type of index ('hierarchical', 'hash', 'auto')
**kwargs: Additional arguments for index

Returns:
Spatial index object

**`convert_to_tensor(self, data: Union[Dict[str, Any], pandas.core.frame.DataFrame, numpy.ndarray], tensor_type: str = 'survey', metadata: Optional[Dict[str, Any]] = None) -> astro_lab.tensors.survey.SurveyTensor`**

Convert simulation data to SurveyTensor.
