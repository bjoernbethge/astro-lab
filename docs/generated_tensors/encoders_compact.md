...
Auto-generated documentation for `astro_lab.models.encoders`
...
```python
from astro_lab.models.encoders import LightcurveTensor
...
```python
from astro_lab.models.encoders import PhotometricTensor
...
```python
from astro_lab.models.encoders import Spatial3DTensor
...
```python
from astro_lab.models.encoders import SpectralTensor
...
```python
from astro_lab.models.encoders import SurveyTensor
